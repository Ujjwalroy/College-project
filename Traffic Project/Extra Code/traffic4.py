...
def Vehicle():
    ...
    while True:
        ...
        cv2.line(frame1, (25, line), (700, line), (255,127,0), 3) 
        cv2.line(frame1, (25, line), (700, line), (255,127,0), 3) 
        for(i,c) in enumerate(contorno):
            ...
            for (x,y) in detec:
                if y<(line+offset) and y>(line-offset):
                    count+=1
                    cv2.line(frame1, (500, line), (500, line), (0,127,255), 3)  
                    detec.remove((x,y))
        ...
        cv2.putText(frame1, "Road_no-4 ",(50,50),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),4)
