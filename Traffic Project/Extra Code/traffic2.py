...
def Vehicle():
    ...
    cap = cv2.VideoCapture('video2.MPG')
    ...
    while True:
        ...
        cv2.putText(frame1, "Vehicle: "+str(count), (450, 70), cv2.FONT_HERSHEY_SIMPLEX, 2, (0, 0, 255),5)
        cv2.putText(frame1, "Road_no-2 ",(50,50),cv2.FONT_HERSHEY_SIMPLEX,1,(255,0,0),4)
